...
import com.gdnews.bean.news_goods;
import com.gdnews.ui.DemoCommentData;
import com.gdnews.utils.Util;
	...
	private void initUI() {
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				 ...
				 * mItemOnClickListener.onItemClick( mActionItems.get(position),
				 * position);
				 */
				if (list.get(position).equals("comment")) {
					
					Intent intent = new Intent();

					intent.setClass(arg1.getContext(), DemoCommentData.class);
